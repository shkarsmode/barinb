import { createEntityState, createState } from 'src/store/creator.util';

import { RoomEntity } from 'src/interfaces/room.interface';

import * as RoomActions from './room.actions';
import { reducer, roomInitialState, RoomState } from './room.reducer';
import { ENTITY_STUB, NEW_ROOM_STUB, ROOM_LOAD_ERROR, ROOM_STUB, ROOMS_STUB } from './room.stud';
